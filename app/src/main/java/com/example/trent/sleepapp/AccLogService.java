...
public class AccLogService extends Service implements SensorEventListener{
    private static final String ANDROID = "Android";
    private static final String DATA = "data";
    private static final String FILES = "files";
    public static final String PREFNAME = "userPrefs";

    private static final String TAG = "AccLogService";
    ...
    private final int ACC_SAMPLING_INTERVAL = 3000000; //1 Hz
...
//        Log.d(TAG, "onStartCommand " + location + " " + activity);
    ...
    private void writeLabel(){
        ...
        File file = new File(f, "accel_logs");
...
//        file = new File(file.getAbsolutePath() + "/" +  android_id  + "_" + date + "_" + location + "_" + activity + "_" + user + "_session" + id + ".csv");
    ...
    */
    ...
    private void startSensing(){
        ...
        //sensorManager.registerListener(AccLogService.this, light, SensorManager.SENSOR_DELAY_FASTEST);
    ...
    private void stopSensing(){
        ...
        try{
            ...
            StorageReference riversRef = mStorageRef.child("acc" + file.getName());
