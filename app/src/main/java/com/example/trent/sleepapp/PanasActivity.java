...
//        pbText.setText("You have completed 4 of 7 tests");
        ...
        ent2 = (EditText) findViewById(R.id.editText3);
        ent3 = (EditText) findViewById(R.id.editText4);
        ent4 = (EditText) findViewById(R.id.editText5);
        ent5 = (EditText) findViewById(R.id.editText6);
        ent6 = (EditText) findViewById(R.id.editText9);
        ent7 = (EditText) findViewById(R.id.editText10);
        ent8 = (EditText) findViewById(R.id.editText11);
        ent9 = (EditText) findViewById(R.id.editText12);
        ent10 = (EditText) findViewById(R.id.editText7);
        ent11 = (EditText) findViewById(R.id.editText17);
        ent12 = (EditText) findViewById(R.id.editText18);
        ent13 = (EditText) findViewById(R.id.editText19);
        ent14 = (EditText) findViewById(R.id.editText16);
        ent15 = (EditText) findViewById(R.id.editText15);
        ent16 = (EditText) findViewById(R.id.editText20);
        ent17 = (EditText) findViewById(R.id.editText21);
        ent18 = (EditText) findViewById(R.id.editText22);
        ent19 = (EditText) findViewById(R.id.editText23);
        ent20 = (EditText) findViewById(R.id.editText24);
