...
//        pbText.setText("You have completed 4 of 7 tests");
        ent1 = (EditText) findViewById(R.id.editTextsca);
        ent2 = (EditText) findViewById(R.id.editTexthos);
        ent3 = (EditText) findViewById(R.id.editTextent);
        ent4 = (EditText) findViewById(R.id.editTextint);
        ent5 = (EditText) findViewById(R.id.editTextdis);
        ent6 = (EditText) findViewById(R.id.editTextexc);
        ent7 = (EditText) findViewById(R.id.editTextups);
        ent8 = (EditText) findViewById(R.id.editTextstr);
        ent9 = (EditText) findViewById(R.id.editTextgui);
